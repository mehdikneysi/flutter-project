...
import 'package:flutter_movie_app/auth/register.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'globals.dart' as globals;

import '../src/core/constants/app_colors.dart';
import '../src/features/parkings/parking_page.dart';
const Guest=true;
const Handicap=false;
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final loginGuestButton = Material(
      elevation: 5,
      borderRadius: BorderRadius.circular(30),
      color:  AppColors.principalColor,
      child: MaterialButton(
      ...
      try {
        await _auth
          ...
          Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (context) => ParkingPages(name: false,
              ))),
        });
